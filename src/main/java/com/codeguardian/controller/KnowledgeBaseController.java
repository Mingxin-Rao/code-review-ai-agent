...
public class KnowledgeBaseController {
    ...
    public ResponseEntity<InputStreamResource> download(@PathVariable String id) {
        ...
        try {
            ...
            String minioObjectName = doc.getMinioObjectName();
            if (minioObjectName != null && minioObjectName.contains(".")) {
                String extension = minioObjectName.substring(minioObjectName.lastIndexOf("."));
    ...
    public String upload(@RequestParam("file") MultipartFile file, RedirectAttributes redirectAttributes) {
        if (file.isEmpty()) {
            redirectAttributes.addFlashAttribute("error", "Please choose a file");
            return "redirect:/admin/knowledge";
        }
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("success", "Document uploaded and processed successfully");
        } catch (Exception e) {
