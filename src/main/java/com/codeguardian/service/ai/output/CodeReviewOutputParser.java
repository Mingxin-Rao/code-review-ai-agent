 ...
 *
 * <p>Parses the JSON response returned by the AI into a list of Finding entities.</p>
 * <p>Parses the JSON response returned by the model into a list of {@link Finding} entities.</p>
 *
 * @since 1.0.0
 */
@Component
