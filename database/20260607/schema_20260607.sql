...
-- Version: v2.2.0
-- Date: 2026-06-07
-- Notes: adds the vector_store table on top of v2.1.0 (vector storage backing RAG semantic search)
-- ============================================
...
-- 2.13 vector_store (Spring AI PGVector store, backing RAG semantic search)
-- Note: managed automatically by spring-ai-pgvector-store; explicit DDL is provided for manual setup
